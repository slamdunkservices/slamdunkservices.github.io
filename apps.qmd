## Slam Dunk Dashboard: All our plays and data, plus historical tracking and unit sizing calculator!
...
<div id="appCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="6000">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="app-carousel-image" src="images/apps/markets.png" alt="Slam Dunk Dashboard markets board listing props with book lines, model lines, edges, and units">
    ...
    <div class="carousel-item">
      <img class="app-carousel-image" src="images/apps/markets-detail.png" alt="Expanded Slam Dunk Dashboard play showing a per-book breakdown with line-movement charts">
    ...
    <div class="carousel-item">
      <img class="app-carousel-image" src="images/apps/game-cards.png" alt="Slam Dunk Dashboard game cards for a slate">
    ...
    <div class="carousel-item">
      <img class="app-carousel-image" src="images/apps/tracking.png" alt="Slam Dunk Dashboard model tracking table and cumulative net units chart">
    ...
    <div class="carousel-item">
      <img class="app-carousel-image" src="images/apps/home-runs.png" alt="Slam Dunk Dashboard MLB home runs markets board">
